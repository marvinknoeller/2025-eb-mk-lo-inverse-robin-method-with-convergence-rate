...
for h_ell in range(num_h):
    ...
    if plot_solution == 1:
        ...
        contour = plt.tricontourf(triangulation, u_interp.x.array,500, cmap="jet")
        plt.axis("equal")
        ...
        contour = plt.tricontourf(triangulation, q.x.array,500, cmap="jet")
        plt.axis("equal")
        plt.rcParams['axes.labelsize'] = 18
        plt.rcParams['xtick.labelsize'] = 18
        plt.rcParams['ytick.labelsize'] = 18
...
plt.loglog(hh, hh*1e1, color='black',linestyle='--', linewidth=2)
plt.loglog(hh, hh**2*9e1, color='black',linestyle='--', linewidth=2)
